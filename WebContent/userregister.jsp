  ...
  <tr><td>STATE:</td> <td>
   ...
   <td>
    ...
    <option value="-1">select</option>
      ...
      <tr><td> PINCODE</td><td> <input type="text" name="pincode"  placeholder="PINCODE" aria-label="PINCODE"  required  ></td><tr>
   <tr><td> MOBILE:</td><td><input type="text" name="mobile"  placeholder="MOBILE" aria-label="MOBILE"  required ></td><tr>
    ...
    <tr><td>PROFESSION:</td><td><input type="text" name="profession"  placeholder="PROFESSION" aria-label="PROFESSION"  required ></td><tr>
