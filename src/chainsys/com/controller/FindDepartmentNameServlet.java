...
/**
 * Servlet implementation class FindDepartmentNameServlet
 */
@WebServlet("/FindDepartmentNameServlet")
public class FindDepartmentNameServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindDepartmentNameServlet() {
        super();
